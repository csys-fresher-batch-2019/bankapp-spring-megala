...
Search
<br/>
Enter AccNo:<input type="number" name="number">
...
<center>
<table border="1" style="border-color:maroon;font-size:20;font-family: monospace;font-style: italic;color: navy;"></center>

<thead class="a"><tr><th>CustomerId</th><th>AccountNo</th><th>AccountType</th><th>AvailableBalance</th><th>Status</th></tr></thead>
<tbody>
<%
for(Account acc:a){%>
<tr>
