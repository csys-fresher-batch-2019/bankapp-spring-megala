...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="addBeneficiary.jsp">Add beneficiary</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="viewBeneficiary.jsp">Beneficiaries</a>
      </li>    
      <li>
      </li>
      <li>
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="viewTransactionHistory.jsp">Transactions</a>
      </li> 
      <li class="nav-item">
