<%@page import="creditcard.CreditCard"%>
...
%><center>
<table border="1" style="border-color:navy;font-size:30px;color:navy;">
<thead class="a"><tr><th>Card Id</th><th>Card Number</th><th>Card Pin</th><th>Cvv Number</th><th>Card Limit</th><th>Expiry Date</th><th>Available Balance</th></tr></thead>
<tbody>
<%
