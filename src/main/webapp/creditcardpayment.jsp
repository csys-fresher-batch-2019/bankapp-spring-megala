...
<%String errorMessage=(String)request.getAttribute("output");
        ...
        <br/>
Enter Card No:<input type="number" name="name" pattern=".{16}"
...
<br/>
Enter pin:<input type="password" name="pin" placeholder="Enter pin number" value="<%=obj1%>">
<br/>
Enter merchantId:<input type="text" name="id" placeholder="Enter merchant Id" required>
<br/>
Enter comments:<input type="text" name="comments" placeholder="Enter comments" required>
<br/>
